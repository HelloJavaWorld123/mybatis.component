...
/**
 * Author：RXK
 * Date:2018/10/21 19:50
 * Version: V1.0.0
 * Des:
 **/
public class CustomerXmlMapperGenerator extends AbstractXmlGenerator {
	...
	protected XmlElement getSqlMapElement() {
		...
		addSelectAllByRecord(answer);

		return answer;
	}

	private void addSelectAllByRecord(XmlElement answer) {
		if (introspectedTable.getRules().generateBaseResultMap()) {
			AbstractXmlElementGenerator elementGenerator = new CustomerXmlElementGenerator();
